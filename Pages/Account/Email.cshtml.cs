...
namespace BelotWebApp.Pages.Account.Manage
{
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.Email != email)
            {
                ...
                var callbackUrl = Url.Page(
                    ...
                    pageHandler: null,
                    values: new { userId = userId, email = Input.Email, code = code },
                    protocol: Request.Scheme);

                await _emailSender.SendEmailAsync(Input.Email, EmailTemplate.ConfirmEmailChange, new Dictionary<string, string>
                {
